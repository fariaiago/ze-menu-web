defmodule ZeMenuSiteWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use ZeMenuSiteWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      import ZeMenuSiteWeb.ConnCase
    end
  end

  setup tags do
    ZeMenuSite.DataCase.setup_sandbox(tags)
  ...
  def register_and_log_in_usuario(%{conn: conn}) do
    usuario = ZeMenuSite.ContaFixtures.usuario_fixture()
  ...
  def log_in_usuario(conn, usuario) do
    token = ZeMenuSite.Conta.generate_usuario_session_token(usuario)
