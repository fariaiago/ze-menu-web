defmodule ZeMenuSite.Conta.Usuario do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, ZeMenuSite.Repo)
  ...
  """
  def valid_password?(%ZeMenuSite.Conta.Usuario{hashed_password: hashed_password}, password)
